...
if(E.injectFull)E.injectFull.addEventListener('change',function(){say(this.checked?'SOURCE INJECT ENABLED':'SOURCE INJECT DISABLED');if(S.normalizedBase)_renderNormalizeOutput()});
